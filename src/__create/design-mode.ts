...
// Local no-op stub. The real design-mode tooling only exists inside the
// create.xyz cloud editor (../../../../shared/design-mode), which isn't part
// of a downloaded/standalone project. Stubbed so the app runs locally.
